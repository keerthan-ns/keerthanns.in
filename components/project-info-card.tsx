...
const WideProjectCard = ({
    ...
    return (
        ...
        >
            ...
            <div className="w-full md:w-1/2 h-fit transition shadow-xl rounded-xl hover:bg-linear-to-r from-gray-900 via-gray-800 to-gray-900 p-0.5 hover:bg-size-[400%_400%] hover:shadow-sm hover:[animation-duration:4s]">
                <div className="flex flex-1 flex-col justify-between">
                    ...
                    <div className="flex flex-col md:flex-row gap-0 md:gap-5 items-center justify-start pb-5 pl-5">
                        <a
                            href={link}
                            target="_blank"
                            className="bg-primary w-fit font-medium text-sm text-white px-5 py-2 rounded-full mt-0 md:mt-5 hover:opacity-80 transition duration-300 ease-in-out group"
                        >
                            Live Demo
                        ...
                        </a>
                        {
                            source && (
                                <a
                                    href={`${source}`}
                                    target="_blank"
                                    className="inline-flex gap-1 items-center bg-white w-fit font-medium text-sm text-gray-900 px-5 py-2 rounded-full mt-2 md:mt-5 hover:opacity-80 transition duration-300 ease-in-out group"
                                >
                                    <IoIosLink size={16} />
                                    Source Code
                                </a>)
